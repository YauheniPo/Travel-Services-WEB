...
<link href="${pageContext.request.contextPath}/css/slider.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/auto/example_auto.css"
	rel="stylesheet" type="text/css" />
					...
					<form name="carform"
						...
						<li>
							<div id="pu_menu-based">
								...
								</select> <select id="puloclist" disabled1="1disabled">
									<option value=""> Select Pick-up Location </option>
									<c:forEach items="${SALON_LIST}" var="j">
										<option value="${j.getAddress()}">${j.getAddress()}</option>
									</c:forEach>
								</select>
							</div> <label for="book_doPrompt" class="ShowLoc"> <input
								id="book_doPrompt" name="book_doPrompt" type="checkbox">Drop
						...
						<li><label for="pu_date" class="book_label">PICK-UP </label>
							<div class="book_stepContainter">
								<div class="cal_wrap">
									<input name="puCal" id="pu_date"
										class="book_calInput hasDatepicker" readonly="readonly"
										value="" type="text"> <input name="pu_datePost"
										id="pu_datePost" class="book_calInput" value="08-09-2017"
										type="hidden">
								</div>

								<select id="ga_pickup_time" class="sfTimesDD"
									name="selDDpu_time">
						...
						<li class="do_dateLi"><label for="do_date" class="book_label">DROP-OFF
						</label>
							<div class="book_stepContainter">

								<div class="cal_wrap">
									<input name="doCal" id="do_date"
										class="book_calInput hasDatepicker" readonly="readonly"
										value="" type="text" /> <input name="do_datePost"
										id="do_datePost" class="book_calInput" value="08-12-2017"
										type="hidden" />
								</div>

								<select id="ga_dropoff_time" class="sfTimesDD"
									name="selDDdo_time">
									<option value="00:00">00:00</option>
									<option value="00:30">00:30</option>
								</select>
							</div></li>
						<button type="submit" class="search book_btn align_right"
							name="submitForm" id="menuSubmitButton">
